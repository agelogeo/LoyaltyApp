...
public class InsertFragment extends Fragment implements View.OnClickListener{
    ...
    private static final String SIGNUP_URL = "https://test-cafeoino.000webhostapp.com/insert.php";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        signup_user = (EditText)v.findViewById(R.id.signup_username);
        signup_pass = (EditText)v.findViewById(R.id.signup_password);
        sLogin = (Button)v.findViewById(R.id.signup_btn);
